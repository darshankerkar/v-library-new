...
function Login() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // TODO: validate credentials if using your own auth; for now redirect to dashboard
    navigate("/dashboard");
  };

  return (
  <div className="min-h-screen bg-linear-to-r from-cyan-200 via-cyan-100 to-cyan-200 flex flex-col">
      {/* Navbar */}
